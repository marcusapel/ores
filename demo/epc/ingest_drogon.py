...
Usage:
  python demo/epc/ingest_drogon.py interop              # full pipeline
  python demo/epc/ingest_drogon.py eqndev               # full pipeline
  python demo/epc/ingest_drogon.py eqndev --skip-etp    # manifest only
  python demo/epc/ingest_drogon.py eqndev --save-only   # build + save, no push
  python demo/epc/ingest_drogon.py eqndev --dry-run     # no remote changes
"""
